    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _products = data
            ...
            .where(
              (p) =>
                  p.category.contains('clothing') ||
                  p.category == 'electronics',
            )
            .toList();
      } else {
        print(
          'FakeStoreAPI failed with status: \${response.statusCode}, falling back to mock data',
        );
        _fallbackToMockData();
      }
    } catch (e) {
  ...
  void _fallbackToMockData() {
    _products = [
      ...
      Product(
        ...
        price: 109.0,
        description:
            "Easy and simple to use, plug and play, Fast data transfers with USB 3.0. Up to 1TB capacities to hold your digital life",
        category: "electronics",
        image: "assets/placeholder.png",
      ),
    ];
